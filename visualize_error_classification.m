...
%     frequency_temp_up = frequency_temp(2);
    ...
    net = load(fullfile(net_path, ['net_', num2str(net_select(1)), '.mat']));
...
save('.\results\Late_Fusion_LSP_cnn_hist_ErrorClassification.mat', 'error_attack_classify', 'error_real_classify');
